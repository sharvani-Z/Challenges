import {
  ...
  useTheme,
  useTimeout
} from "./chunk-DOHEOMSM.js";
import {
  require_prop_types
} from "./chunk-AZOQSLXG.js";
import {
  require_react_is
} from "./chunk-WJQVYNBC.js";
import {
  require_jsx_runtime
...
var inputOverridesResolver = (props, styles4) => {
  ...
  return [styles4.input, ownerState.type === "search" && styles4.inputTypeSearch];
};
...
var RovingTabIndexContext = React13.createContext(void 0);
if (true) {
  RovingTabIndexContext.displayName = "RovingTabIndexContext";
}
function useRovingTabIndexContext() {
  const context = React13.useContext(RovingTabIndexContext);
  if (context === void 0) {
...
function useRovingTabIndexRoot(params) {
  ...
  const [activeItemIdState, setActiveItemIdState] = React14.useState(activeItemIdProp);
  const previousActiveItemIdPropRef = React14.useRef(activeItemIdProp);
  ...
  const itemMapRef = React14.useRef(/* @__PURE__ */ new Map());
  const [mapTick, setMapTick] = React14.useState(0);
  const orderedItems = React14.useMemo(() => {
  ...
  const activeItemIdRef = React14.useRef(resolvedActiveItemId);
  activeItemIdRef.current = resolvedActiveItemId;
  const getActiveItem = React14.useCallback(() => {
  ...
  const getItemMap = React14.useCallback(() => {
  ...
  const isItemActive = React14.useCallback((itemId) => {
    return activeItemIdRef.current === itemId;
  }, []);
  const focusItem = React14.useCallback((currentIndex, direction, wrap2, isItemFocusableOverride) => {
    var _a;
  ...
  const getContainerProps = React14.useCallback((ref) => {
    const onFocus = (event) => {
      const snapshot = getNavigableItemsSnapshot(itemMapRef.current);
  ...
  const focusNext = React14.useCallback((isItemFocusableOverride) => {
    var _a;
    const snapshot = getNavigableItemsSnapshot(itemMapRef.current);
    const currentFocus = activeElement(ownerDocument(containerRef.current));
    const isFocusOnContainer = currentFocus === containerRef.current;
...
function useRovingTabIndexItem(params) {
  ...
  const latestItemRef = React14.useRef(item);
  latestItemRef.current = item;
  const handleElementRef = React14.useCallback((element) => {
...
var SelectFocusSourceContext = React17.createContext(null);
if (true) {
  SelectFocusSourceContext.displayName = "SelectFocusSourceContext";
}
function useSelectFocusSource() {
  const context = React17.useContext(SelectFocusSourceContext);
  return context;
}
...
var MenuListContext = React18.createContext(void 0);
if (true) {
  MenuListContext.displayName = "MenuListContext";
}
function useMenuListContext() {
  const context = React18.useContext(MenuListContext);
  if (context === void 0) {
...
var MenuList = React19.forwardRef(function MenuList2(props, ref) {
  ...
  const hasFocusedInitialTargetRef = React19.useRef(false);
  const [suppressInitialFocusVisible, setSuppressInitialFocusVisible] = React19.useState(false);
  ...
  const getDefaultActiveItemId = React19.useCallback((items) => {
    var _a, _b, _c;
  ...
  const menuListContextValue = React19.useMemo(() => ({
  ...
  return (0, import_jsx_runtime12.jsx)(List_default, {
    ...
    tabIndex: -1,
    ...other,
    children: (0, import_jsx_runtime12.jsx)(MenuListContext.Provider, {
      value: menuListContextValue,
      children: (0, import_jsx_runtime12.jsx)(RovingTabIndexContext.Provider, {
...
var Fade = React23.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(Transition_default, {
    appear,
    in: inProp,
    nodeRef,
    onEnter: handleEnter,
    ...
    children: (state, {
      ...
      const childStyle = getTransitionChildStyle(state, inProp, styles3, hiddenStyles2, style, children.props.style);
...
var Modal = React26.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime17.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop ? (0, import_jsx_runtime17.jsx)(BackdropSlot, {
        ...backdropProps
...
var SelectInput = React31.forwardRef(function SelectInput2(props, ref) {
  ...
  const openRef = React31.useRef(false);
  const hasSelectedItemInListRef = React31.useRef(false);
  const openingMouseUpListenerCleanupRef = React31.useRef(null);
  const didPointerDownOnItemRef = React31.useRef(false);
  const selectionRef = React31.useRef({
  ...
  const [openInteractionType, setOpenInteractionType] = React31.useState(null);
  ...
  const clearOpeningMouseUpListener = React31.useCallback(() => {
  ...
  return (0, import_jsx_runtime22.jsxs)(React31.Fragment, {
    children: [(0, import_jsx_runtime22.jsx)(SelectSelect, {
      ...
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime22.jsx)(SelectFocusSourceProvider, {
      value: openInteractionType,
      children: (0, import_jsx_runtime22.jsx)(Menu_default, {
        id: `menu-${name || ""}`,
...
//# sourceMappingURL=chunk-U46TPR6H.js.map
